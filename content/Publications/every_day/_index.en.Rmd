...
Presentation for [eRum2020](https://2020.erum.io).

```{r embed2, out.extra='style="border: none;"', out.width='99%', fig.cap="Embedded eRum presentation", echo = FALSE}
knitr::include_url('https://rtoolboxerum.netlify.app/#1')
```
